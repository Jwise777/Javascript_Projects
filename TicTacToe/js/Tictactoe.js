...
function placeXOrO(squareNumber) {
    ...
    if (!selectedSquares.some(element => element.includes(squareNumber))) {
        ...
        if (activePlayer === 'X') {
            ...
            select.style.backgroundImage = 'url("./images/X.jfif")';
            //Active player may only be 'X' or 'O' so, if no 'X' it must be 'O'
        } else {
            //If activePlayer is equal to '0', the o.png is placed in HTML
            select.style.backgroundImage = 'url("./images/O.jfif")';
        }
        ...
        if (activePlayer === 'X') {
            //If active payer is 'X' change it to 'O'.
            activePlayer = 'O';
    ...
    function computersTurn() {
        ...
        //This function takes a string paramter of the pather you set earlier for placement sound ('./media/Sound.mp3)
        ...
        function drawWinLine(coordX1, coordY1, coordX2, coordY2) {
            ...
            let x1 = coordX1,
                ...
                x = x1,
                //This varaible stores temporary y axis data we update in our animation loop.
                y = y1;
            ...
            function animateLineDrawing() {
                ...
                c.stroke();
                //This condition checks if we've reached endpoints.
                if (x1 <= x2 && y1 <= y2) {
            ...
            //This function clears our canvas after our win live is drawn.
            function clear() {
            ...
            animateLineDrawing();
            //This line waits 1 second. Then, clears canvas, resets games, an allows clicking again.
