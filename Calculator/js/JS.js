...
function Handle_Operator(Next_Operator) {
    ...
    //and then store the result in Calculator.First_Operand if it doesn't already exist.
    ...
    if (First_Operand == null) {
        ...
        //and the function that matches the operator is exectued.
...
function Update_Display() {
    //Makes use of the calculator-screen class to target the inpute tag in the HTML document
...
keys.addEventListener('click', (event) => {
    ...
    //Ensures that AC clears all inputes from the calculator screen.
